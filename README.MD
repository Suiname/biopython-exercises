## Python for Genomics final project

This is the final project for the coursera course ["Python for Genomic Data Science"](https://www.coursera.org/learn/python-genomics)
